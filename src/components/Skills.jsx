...
function Skills() {
  ...
  return (
    <div className="bg-white dark:bg-black text-black dark:text-white" name="Expertise">
      <div className="max-w-6xl mx-auto p-4 py-20 sm:px-5" data-aos="fade-up" data-aos-delay="300">
              ...
              {skill.img && (
                <img
                  ...
                  className={`w-24 h-24 md:w-20 md:h-20 mb-3 md:mb-4 ${
                    skill.skill === "Expressjs" ? "express-icon-black" : ""
                  }`}
                />
              )}
              {skill.icon && <div className="text-3xl md:text-4xl">{skill.icon}</div>}
